<template>
  ...
  <v-container fluid class="pa-0">
    <v-parallax :src="backdropUrl + singleMovie.backdrop_path">
      <div class="wrap">
      <div class="item-content">
        <div class="item-data-wrap">
          ...
          <div class="teaser-buttons no-select">
            ...
            <a :href="`https://www.themoviedb.org/movie/${singleMovie.tmdb_id}`" target="_blank"
              ...
              <span v-if="singleMovie.tmdb_id"><b>{{ singleMovie.tmdb_id }}</b> TMDb</span>
            ...
            <a v-if="singleMovie.imdb_id" :href="`http://www.imdb.com/title/${singleMovie.imdb_id}`" target="_blank"
              ...
              <span v-if="singleMovie.imdb_id"><b>{{ singleMovie.imdb_id }}</b> IMDb</span>
